...
\title{Feedback Control for Level and Flow Management}
...
%%%%%%%%%1%%%%%%%%%2%%%%%%%%%3%%%%%%%%%4%%%%%%%%%5%%%%%%%%%6
\begin{frame}{Maximum Controllable Inflows 1970--1999}

\begin{center}
\includegraphicscopyright[width=0.8\paperwidth]{RLMaxFlow1970.png}{Source: \href{http://jckantor.github.io/Rainy-Lake-Hydrology/}{Github Repository for this paper.}}
\end{center}

\end{frame}

%%%%%%%%%1%%%%%%%%%2%%%%%%%%%3%%%%%%%%%4%%%%%%%%%5%%%%%%%%%6
\begin{frame}{Maximum Controllable Inflows 2000-2014}
...
%%%%%%%%%1%%%%%%%%%2%%%%%%%%%3%%%%%%%%%4%%%%%%%%%5%%%%%%%%%6
\begin{frame}{Uncontrollable Inflow Freq, 1970-1999}

\begin{center}
\includegraphicscopyright[width=0.8\paperwidth]{RLMaxFlowFreq1970.png}{Source: \href{http://jckantor.github.io/Rainy-Lake-Hydrology/}{Github Repository for this paper.}}
\end{center}

\end{frame}

%%%%%%%%%1%%%%%%%%%2%%%%%%%%%3%%%%%%%%%4%%%%%%%%%5%%%%%%%%%6
\begin{frame}{Uncontrollable Inflow Freq, 2000-2014}
...
\section{Assessment of Simulation Results}
}
